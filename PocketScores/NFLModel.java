...
/**
 * Last updated: 2020-12-01 This is the model for the NFL game. It's purpose is
 * to handle the data returned from the translator. This app simply displays
 * data without altering it; the methods here only call and return the output of
 * methods from the translator, SportsFeedTranslator.
 *
