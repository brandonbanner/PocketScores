...
/**
 * Last updated: 2020-12-01 This is the translator which connects to the adapter
 * class SportsFeedAPIAdapter. It's purpose is to pull specific information from
 * the data which the adapter returns from the API. Contributing authors:George
 * Bell
 */
