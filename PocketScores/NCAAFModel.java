...
/**
 * Last updated: 2020-11-30 This is the model for the NCAA football. It's
 * purpose is to handle the data returned from the translator. This app simply
 * displays data without altering it; the methods here only call and return the
 * output of methods from the translator, SportsFeedTranslator.
 *
